...
<<<<<<< HEAD:HiPMobile/HiPMobile/Common/DbDummyDataFiller.cs
...
using Realms;
=======
>>>>>>> 557187479ed9b76e94da697aff291be3637623db:Sources/HiPMobile/Common/DbDummyDataFiller.cs
    ...
    public class DbDummyDataFiller {
        ...
        public void InsertData ()
        {
            ...
            using (DbManager.StartTransaction ())
            {
                ...
                kaiserpfalz.Pages.Add (
                    CreateImagePage (
                        CreateImage ("Blick auf die Grabungsfläche",
                                     "Blick vom Dom auf die Grabungsfläche der Paderborner Pfalz. \n[Bildnachweis: 799. Kunst und Kultur der Karolingerzeit. Karl der Große und Papst Leo III. in Paderborn. Beiträge zum Katalog der Ausstellung Paderborn 1999, Mainz 1999, S. 178, Abb. 3]",
                                     "kaiserpfalz_image_3_2.jpg"), null, null,
                        CreateAudio ("sprechertext_3_2.mp3",
                ...
                kaiserpfalz.Pages.Add (
                    CreateImagePage (
                        CreateImage ("Rekonstruktion der Aula", "Rekonstruktion der Aula , Bauphase Ib. \n[Bildnachweis: Gai / Mecke 2004, S. 120, Abb. 68]",
                                     "kaiserpfalz_image_5_1.jpg"), null, null,
                        CreateAudio ("sprechertext_5_1.mp3",
                                     "Eine Vorstellung, wie diese aula regia bei der Reichsversammlung im Jahre 785 ausgesehen haben könnte, vermittelt Ihnen die Zeichnung der Archäologinnen Sveva Gai und Birgit Mecke auf Ihrem Display.\n" +
                ...
                kaiserpfalz.Pages.Add (
                    CreateImagePage (
                        CreateImage ("Grundriss der Salvatorkirche", "Grundrisses der Salvatorkirche. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 108]",
                                     "kaiserpfalz_image_5_2.jpg"), null, null,
                        CreateAudio ("sprechertext_5_2.mp3",
                                     "Wie Sie sicherlich schon bemerkt haben, zeichnet die Pflasterung keinen vollständigen Grundriss nach. Die Linien verschwinden unter dem heutigen Dom. Den gesamten Grundriss dieser Salvatorkirche können Sie nun auf Ihrem Display sehen. Es handelte sich vermutlich um eine einschiffige Saalkirche, deren rechteckiger Chor im Osten dreigeteilt war. Im Westen schloss die Kirche mit einem rechteckigen Westbau ab, dessen Gestalt unklar bleibt.",
                                     "")));
                kaiserpfalz.Pages.Add (
                    CreateImagePage (
                        CreateImage ("Rekonstruktion der Salvatorkirche", "Rekonstruktion der Salvatorkirche. \n[Bildnachweis: Gai / Mecke 2004, Bd. 1, S. 122]",
                                     "kaiserpfalz_image_5_3.jpg"), null, null,
                        CreateAudio ("sprechertext_5_3.mp3",
                ...
                sliderTimes2.Add (0);
                slider2.Add (CreateImage ("",
                                          "Aachen, die karolingische Pfalz, erhaltene Fundamente. \n[Bildnachweis: Keller, Christoph : Archäologische Forschungen in Aachen, Mainz 2004, S. 52]",
                                          "kaiserpfalz_slider_7_2.jpg"));
                sliderTimes2.Add (1);
                ...
                sliderTimes2.Add (2);
                kaiserpfalz.Pages.Add (CreateTimeSliderPage ("Grundrisse", "Maßstabsgetreue Grundrisse der Pfalzanlagen in Paderborn, Aachen und Ingelheim.",
                                                             sliderTimes2.ToArray (), slider2.ToArray (), true,
                                                             CreateAudio ("sprechertext_7_2.mp3", "Einen Eindruck der Größenverhältnisse vermittelt Ihnen der Slider.", "")));

                kaiserpfalz.Pages.Add (
                    CreateImagePage (
                        CreateImage ("Museum in der Kaiserpfalz", "Entdecken Sie im Museum in der Kaiserpfalz Fundstücke aus der karolingischen Pfalzanlage!",
                                     "kaiserpfalz_teaser.jpg"), null, null,
                        CreateAudio ("sprechertext_8.mp3",
